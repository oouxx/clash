...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/oouxx/clash/constant.Version=$(VERSION)" \
		-X "github.com/oouxx/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
